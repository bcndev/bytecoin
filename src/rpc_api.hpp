...
// bool - Bool
// Amount, SignedAmount, Height, Timestamp, UnlockMoment, Difficulty, (u)int - Number. bytecoin does not use fractional numbers, but uses numbers as large as 2^64-1 for amounts, which is larger than 2^53 exactly representable in double or JavaScript Number
...
namespace bytecoin { namespace api {
...
namespace bytecoin { namespace api { namespace bytecoind {
...
//		bool send_signatures = false; // Signatures are checked by bytecoind so usually they are of no interest
	};
	struct SyncBlock {
		api::BlockHeader header;
		bytecoin::Block block; // the only method returning actual Block from blockchain, not api::Block
...
void serMembers(bytecoin::api::EmptyStruct &v, ISeria &s);
void serMembers(bytecoin::api::Output &v, ISeria &s);
void serMembers(bytecoin::api::BlockHeader &v, ISeria &s);
void serMembers(bytecoin::api::Transfer &v, ISeria &s);
void serMembers(bytecoin::api::Transaction &v, ISeria &s);
void serMembers(bytecoin::api::Block &v, ISeria &s);
void serMembers(bytecoin::api::Balance &v, ISeria &s);

void serMembers(bytecoin::api::walletd::GetAddresses::Response &v, ISeria &s);
void serMembers(bytecoin::api::walletd::GetViewKeyPair::Response &v, ISeria &s);
...
void serMembers(bytecoin::api::walletd::GetBalance::Response &v, ISeria &s);
void serMembers(bytecoin::api::walletd::GetUnspents::Request &v, ISeria &s);
void serMembers(bytecoin::api::walletd::GetUnspents::Response &v, ISeria &s);
void serMembers(bytecoin::api::walletd::GetTransfers::Request &v, ISeria &s);
void serMembers(bytecoin::api::walletd::GetTransfers::Response &v, ISeria &s);
void serMembers(bytecoin::api::walletd::CreateTransaction::Request &v, ISeria &s);
void serMembers(bytecoin::api::walletd::CreateTransaction::Response &v, ISeria &s);
void serMembers(bytecoin::api::walletd::CreateSendProof::Request &v, ISeria &s);
void serMembers(bytecoin::api::walletd::CreateSendProof::Response &v, ISeria &s);
...
void serMembers(bytecoin::api::bytecoind::GetStatus::Request &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::GetStatus::Response &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::SyncBlocks::Request &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::SyncBlocks::SyncBlock &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::SyncBlocks::Response &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::SyncMemPool::Request &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::SyncMemPool::Response &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::GetRandomOutputs::Request &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::GetRandomOutputs::Response &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::SendTransaction::Request &v, ISeria &s);
void serMembers(bytecoin::api::bytecoind::SendTransaction::Response &v, ISeria &s);

...
void Agent::Connection::on_disconnect() {
	disconnect();
}


Agent::Agent(const std::string &address, uint16_t port) : sent_request(nullptr), address(address), port(port),

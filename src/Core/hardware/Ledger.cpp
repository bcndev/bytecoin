...
std::vector<cn::PublicKey> Ledger::mul_by_view_secret_key(const std::vector<PublicKey> &output_public_keys) {
...
cn::KeyImage Ledger::generate_keyimage(
    const PublicKey &output_public_key, const SecretKey &inv_output_secret_hash, size_t address_index) {
	KeyImage result;
	return result;
}

void Ledger::generate_output_seed(const Hash &tx_inputs_hash, size_t out_index, PublicKey *output_seed) {}
...
void Ledger::sign_step_a(SecretKey inv_output_secret_hash, size_t address_index, crypto::EllipticCurvePoint *sig_p,
...
void Ledger::sign_step_b(SecretKey inv_output_secret_hash, size_t address_index, crypto::EllipticCurveScalar my_c,
...
void Ledger::export_view_only(SecretKey *audit_key_base_secret_key, SecretKey *view_secret_key,

...
class SignTx : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.bitcoin.SignTx) */ {
 ...
 private:
  ...
  void set_has_branch_id();
  void clear_has_branch_id();
...
inline void SignTx::set_has_branch_id() {
  _has_bits_[0] |= 0x00000100u;
}
inline void SignTx::clear_has_branch_id() {
  _has_bits_[0] &= ~0x00000100u;
}
...
inline void TxAck_TransactionType::set_has_branch_id() {
  _has_bits_[0] |= 0x00000400u;
}
inline void TxAck_TransactionType::clear_has_branch_id() {
  _has_bits_[0] &= ~0x00000400u;
}

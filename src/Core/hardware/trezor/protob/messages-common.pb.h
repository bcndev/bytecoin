...
class PassphraseStateRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.PassphraseStateRequest) */ {
 public:
  ...
  inline PassphraseStateRequest* New() const final {
    return CreateMaybeMessage<PassphraseStateRequest>(NULL);
  }
...
class PassphraseStateAck : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.PassphraseStateAck) */ {
 public:
  PassphraseStateAck();
  ...
  inline PassphraseStateAck* New() const final {
    return CreateMaybeMessage<PassphraseStateAck>(NULL);
  }
